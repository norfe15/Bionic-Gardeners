		...
		<main>
			<>
				...
				<div className="shop-info">
					...
					<p>
						American Burgers är en väldigt ny restaurang som ligger
						på adressen <i>10 Old Street, London</i> i Sverige, men
						vi är redan världsledande inom amerikanska burgare i
				...
				<div className="shop-info">
					...
					<p>
						Många av våra kockar kommer egentligen ifrån Amerika,
						men som har flyttat till Sverige för att få ett lugnare
						liv och som vill ge sin kärlek till mat till oss i
						övriga världen.
					</p>
				</div>
				...
				<div className="shop-info">
					...
					<p>
						Nästa månad kommer vi servera våra besökare Korean
						fushion style hamburgare med gnutta amerikansk känsla.
						Den hamburgaren kommer bara finnas i våran meny i en
						begränsad tid, så passa på att skaffa den när den ändå
						finns!
					</p>
				</div>
				...
				<div className="shop-info">
					...
					<p>
						...
						lägga till i våran meny. Eller kan du kontakta oss för
						att ge oss synpunkter på något. Vi är alltid glada att
